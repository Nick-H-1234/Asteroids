public class Asteroid extends Polygon {
    ...
    public Asteroid(Point[] shape, double scale, Point position, double speed, double direction) {
        super (shape, scale, position, 0, (Math.random() < 0.5 ? 1 : -1)*Math.random(), speed, direction);
        this.speed = speed;
    }
}